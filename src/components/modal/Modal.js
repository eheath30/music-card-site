...
const Modal = ({
  ...
  return (
    <div
      key={key}
      id="myModal"
      className={`modal songModal ${show ? "showModal" : "hideModal"}`}
    >
      <div className="modal-content">
        ...
        <div className="containerInModal">
          <iframe
            className="mx-auto my-4 rounded video"
            width="560"
            height="315"
            src={embededURL}
        ...
        <div className="container text-center mb-5 lyrics-in-the-modal h-100">
          {loading ? loadingGiphy : songLyrics}
        </div>
      </div>
    </div>
  );
